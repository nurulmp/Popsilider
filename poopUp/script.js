var imageUrls =['url("images/model-1.jpg")','url("images/model-2.jpg")',
'url("images/model-4.jpg")','url("images/model-5.jpg")','url("images/model-6.jpg")',
'url("images/model-7.jpg")','url("images/model-8.jpg")','url("images/model-9.jpg")',
'url("images/model-10.jpg")','url("images/model-11.jpg")','url("images/model-12.jpg")']
...
function imagePop(id){
	...
	document.getElementsByClassName('imageConatin')[0].style.animation = 'he 800ms forwards'

	document.getElementsByClassName('imageConatin')[0].style.backgroundImage = imageUrls[imageIndex]
